        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              For {franchises.length} franchise{franchises.length !== 1 ? 's' : ''}
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        {isSuccess ? (
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-gray-500">
              We&apos;ll send you detailed information about these franchises within 24-48 hours.
            </p>
          </div>
        ) : (
          <>
            ...
            <div className="p-6 border-b bg-gray-50">
              <h3 className="text-sm font-semibold text-gray-700 mb-3">Selected Franchises:</h3>
              <div className="space-y-2 max-h-32 overflow-y-auto">
                {franchises.map((franchise) => (
                  ...
                  >
                    ...
                    <span className="font-medium truncate">{franchise.name}</span>
                    <span className="text-gray-500 text-xs">({franchise.category})</span>
                  </div>
                ))}
              </div>
            </div>
